...
public final class ActivityFirstBinding implements ViewBinding {
  ...
  private ActivityFirstBinding(@NonNull RelativeLayout rootView, @NonNull ImageView i1img,
  ...
  public static ActivityFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFirstBinding((RelativeLayout) rootView, i1img, inxtBtn, main);
    }
