...
public final class FragmentTaskBinding implements ViewBinding {
  ...
  private FragmentTaskBinding(@NonNull RelativeLayout rootView, @NonNull TextView timerText) {
  ...
  public static FragmentTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTaskBinding((RelativeLayout) rootView, timerText);
    }
