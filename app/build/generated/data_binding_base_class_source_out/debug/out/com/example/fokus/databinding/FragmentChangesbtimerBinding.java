...
public final class FragmentChangesbtimerBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentChangesbtimerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentChangesbtimerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_changesbtimer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentChangesbtimerBinding bind(@NonNull View rootView) {
