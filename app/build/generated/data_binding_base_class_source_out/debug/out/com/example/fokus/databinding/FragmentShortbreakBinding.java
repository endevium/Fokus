...
public final class FragmentShortbreakBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentShortbreakBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentShortbreakBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_shortbreak, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentShortbreakBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentShortbreakBinding((RelativeLayout) rootView, fragmentContainer,
          linearTimer, playButton, restartButton, sbnxtBtn, stopBtn, timerTextView, tvPomodoro,
          tvPomodoroDesc);
    }
